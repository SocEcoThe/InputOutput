...
public class CacheManager {
    ...
    private List<ItemOperation> operations;
    ...
    // 记录投入操作
    public synchronized void recordInput(String playerName, int amount,String itemName) {
        operations.add(new ItemOperation(playerName,"input",itemName,amount));
    }

    // 记录产出操作
    public synchronized void recordOutput(String playerName, int amount,String itemName) {
